...
const RefundContent = () => {
  return (
    <>
      ...
      <div className="container px-5 mx-auto sm:mb-32 mb-10 pb-10 pt-5 text-white opacity-60 text-[15px] font-normal 2xl:max-w-[1300px] ff_lato">
        <h4>OVERVIEW</h4>
        <p className="pb-4 sm:pb-5">
          This website is operated by United deals. Throughout the site, the
          terms “we”, “us” and “our” refer to United deals. United deals offers
        ...
        <p className="pb-4 sm:pb-5">
          To start a return, you can contact us at united
          deals.contact@gmail.com.
        </p>
        <p className="pb-4 sm:pb-5">
        ...
        <p className="pb-4 sm:pb-5">
          You can always contact us for any return question at united
          deals.contact@gmail.com.
        </p>
        <p className="pb-4 sm:pb-5">
          Damages and issues <br /> Please inspect your order upon reception and
        ...
        <p className="pb-4 sm:pb-5">
          Exchanges <br /> The fastest way to ensure you get what you want is to
          return the item you have, and once the return is accepted, make a
          separate purchase for the new item.
        </p>{" "}
        <p className="pb-4 sm:pb-5">
          European Union 14 day cooling off period <br />
        ...
        <p className="pb-4 sm:pb-5">
          ...
          credit card company to process and post the refund too. <br />
          If more than 15 business days have passed since we’ve approved your
          return, please contact us at united deals.contact@gmail.com. <br />
        ...
        <p className="pb-4 sm:pb-5">
          ...
          Refund Policy: [LINK TO REFUND POLICY] <br />
          ...
          for any product or Service made on this site is void where
        ...
        <p className="pb-4 sm:pb-5">
          For more details, please review our Refund Policy:  https://united
          deals.tech/policies/refund-policy
        </p>
        ...
        <p className="pb-4 sm:pb-5">
          ...
          by our Privacy Policy, which can be viewed here:  https://united
          deals.tech/policies/privacy-policy
        </p>
        ...
        <p className="pb-4 sm:pb-5">
          ...
          In no case shall United deals, our directors, officers, employees,
        ...
        <p className="pb-4 sm:pb-5">
          You agree to indemnify, defend and hold harmless United deals and our
        ...
        <p className="pb-4 sm:pb-5">
          ...
          time at this page. <br /> We reserve the right, at our sole
