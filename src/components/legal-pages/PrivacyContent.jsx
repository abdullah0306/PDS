  ...
  return (
    <>
      ...
      <div className="container px-5 mx-auto sm:mb-32 mb-10 pb-10 pt-5 text-white opacity-60 text-[15px] font-normal 2xl:max-w-[1300px] ff_lato">
        <p>
          This Privacy Policy describes how United deals (the "Site", "we",
          "us", or "our") collects, uses, and discloses your personal
          information when you visit, use our services, or make a purchase from
          united dealsclub.com (the "Site") or otherwise communicate with us
        ...
        <div className="flex gap-3 items-center ps-3">
          <span className="w-2 h-2 rounded-full bg-white inline-block min-w-2"></span>
          <p>
        ...
        <div className="flex gap-3 items-center ps-3">
          ...
          <p>
            ...
            support personalized advertising with third-party services. Our
        ...
        <p>CategoryCategories of Recipients</p>
        <div className="flex gap-3 items-center ps-3">
          <span className="w-2 h-2 rounded-full bg-white inline-block min-w-2"></span>
          <p>
        ...
        <p>
          Category of Personal InformationCategories of RecipientsIdentifiers
          such as basic contact details and certain order and account
          informationBusiness and marketing partnersCommercial information such
          as records of products or services purchased and shopping
          informationBusiness and marketing partnersInternet or other similar
          network activity, such as Usage DataBusiness and marketing partners
        </p>
        ...
        <p>
          ...
          personal information for such services,
          visit https://privacy.shopify.com/en.
        </p>
        <p>Complaints</p>
        <p>
        ...
        <p>
          ...
          available to you, email us at united deals.contact@gmail.com or
          contact us at A-3/B, S.G. Towers, Bhiringi Mondal Para, Benachity,
          Durgapur, Paschim Bardhaman,West Bengal,India-713213.
        </p>
      </div>
    </>
  );
