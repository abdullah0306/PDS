  ...
  return (
    <>
      ...
      <div className="container px-5 mx-auto sm:mb-32 mb-10 pb-10 pt-5 text-white opacity-60 text-[15px] font-normal 2xl:max-w-[1300px] ff_lato">
        ...
        <p className="pb-4 sm:pb-5">
          Questions about the Terms of Service should be sent to us at united
          deals.contact@gmail.com. <br />
          Our contact information is posted below: <br />
          United deals <br />
          united deals.contact@gmail.com <br />
          A-3/B, S.G. Towers, Bhiringi Mondal Para, Benachity, Durgapur, Paschim
          Bardhaman,West Bengal,India-713213. <br />
          <a href="tel:7319265132">+91 7319265132</a>
        </p>
      </div>
    </>
  );
